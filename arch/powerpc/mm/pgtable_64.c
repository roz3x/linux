...
unsigned long __pmd_masked_bits;
EXPORT_SYMBOL(__pmd_masked_bits);
unsigned long __pud_masked_bits;
EXPORT_SYMBOL(__pud_masked_bits);
unsigned long __pgd_masked_bits;
EXPORT_SYMBOL(__pgd_masked_bits);
unsigned long __pte_rpn_mask;
EXPORT_SYMBOL(__pte_rpn_mask);
unsigned long __page_pte;
EXPORT_SYMBOL(__page_pte);
